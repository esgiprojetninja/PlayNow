    ...
    <div id="fixed-container">
        <div id="slide1" class="landing-slide">
            <div class="landing-text">
                <h3>
                    Organisez <span class="strong">des matchs</span> en 2 clics !
                </h3>
                <p>
        ...
        <div id="slide2" class="landing-slide">
            <div class="landing-text">
                <h3>
                    Trouvez des <span class="strong">joueurs</span> partout, tout le temps !
                </h3>
                <p>
        ...
        <div id="slide3" class="landing-slide">
            <div class="landing-text">
                <h3>
                    Profitez d'une <span class="strong">communauté</span> qui vous ressemble !
                </h3>
                <p>
